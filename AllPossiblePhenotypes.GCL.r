AllPossiblePhenotypes.GCL <- function(markerset){
  ...
  # 
  #   AllPossiblePhenotypes.GCL(markerset = c("Ots_vatf-251", "Ots_ZR-575"))
  #
  # Note~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
  #
  #   This function is called on by CombineLoci.gcl and requires a LocusControl object. Run CreateLocusControl.GCL prior to this function.
  #~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~  
